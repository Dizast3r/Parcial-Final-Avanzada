 ...
 * Extiende JpaRepository para operaciones CRUD básicas y define consultas personalizadas
 * para validaciones y operaciones específicas del dominio.
 * 
...
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
    ...
    /**
     * Busca un usuario por sus credenciales (nickname y password).
     * Utilizado para autenticación.
     * 
     * @param nickname Nickname del usuario
     * @param password Password del usuario
     * @return El usuario si las credenciales son correctas, null si no coinciden
     */
    Usuario findByNicknameAndPassword(String nickname, String password);
    
    /**
     * Verifica si existe una suscripción entre dos usuarios.
     * Utiliza una consulta JPQL para verificar la relación many-to-many.
     * 
     ...
     * Utiliza una consulta JPQL para acceder a la colección de suscripciones.
     * 
     ...
     * Utiliza una consulta JPQL para acceder a la colección de suscriptores.
     * 
